export default function Home() {
  return (
    <div className="relative h-dvh w-full grid place-content-center">
      <div className="absolute right-0 -z-30 w-xl">
        <img src="/1.png" className="object-cover w-full h-full" />
      </div>
      <div className="absolute left-0 -z-30 w-xl scale-x-[-1]">
        <img src="/1.png" className="object-cover w-full h-full" />
      </div>
      <div className="absolute top-0 left-0 right-0 bottom-1/2 -z-30 bg-gradient-to-b from-gray-500 to-brand-light-green/1"></div>
      <div className="absolute rounded-t-full bg-linear-to-t bg-brand-gold/60 from-5% to-white bottom-1/4 top-3/12 right-4/12 left-4/12 -z-20"></div>
